        ...
        >
          <div className="flex w-fit items-center gap-3 p-2 max-lg:justify-center">
            ...
            <div className="flex flex-col items-start text-sm whitespace-nowrap text-slate-700">
              <h2 className="font-medium text-slate-900">Radha Gupta</h2>
              <p className="text-slate-500">FullStack engineer, Mern Stack Developer</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 max-lg:items-center">
            ...
            <Text className="max-w-2xl text-center text-balance">
             Crafting scalable, maintainable web applications using React, Next.js, Node.js, MongoDB, and SQL. I&apos; Excited to contribute to full-time projects that prioritize performance, architecture, and user experience.
